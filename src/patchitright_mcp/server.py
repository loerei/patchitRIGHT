        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "target_file": {
                        "type": "string",
                        "description": "Absolute or relative path to the target file. Absolute paths can target any file on the system. Relative paths are resolved against the active workspace root and are restricted to it."
                    },
                    "search_content": {
                        "type": "string",
